...
graph LR
    ...
    G3 --> G4[Gate 4: SRE, Security & FinOps<br/>🛡️ SRE / 🔒 SecOps / 💰 FinOps]
    G4 --> G5[Gate 5: Git & Docs Sync<br/>🔀 Git & Docs Engineer]
    G5 --> G6[Gate 6: GTM Distribution<br/>🚀 Growth & Release]
    G6 --> Done([🏁 Shipped to Production])
```
